--[[ 
    FILE: fishing_GARxcuy_v1.2.lua (MOD Auto Favorite v4.0)
    VERSION: 1.2 (Update: Auto Join Classic Event + Auto Favorite Inventory Based)
]]
...
local GUI_NAMES = {
    Main = "GArxCUY_Fishing_UI",
    Mobile = "GArxCUY_Mobile_Button",
    Coords = "GArxCUY_Coords_HUD"
}
...
for _, v in pairs(CoreGui:GetDescendants()) do
    if v:IsA("TextLabel") and v.Text == "GArxCUY" then
